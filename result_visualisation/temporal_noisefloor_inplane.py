...
def main() -> None:
    # In plane RBM
    base_dir1 = Path.cwd() / "DIC results/In pipe/In plane/optimised calib"
    base_dir2 = Path.cwd() / "DIC results/Out of pipe/In Plane/optimised calib"
    ...
    # plt.show()
    filename = Path.cwd() / "Error_maps/in_plane_noisefloor.svg"
