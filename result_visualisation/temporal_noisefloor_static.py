...
def main() -> None:
    # In plane RBM
    base_dir1 = Path.cwd() / "DIC results/In pipe/Static/In plane/optimised"
    base_dir2 = Path.cwd() / "DIC results/Out of pipe/Static/Out of plane/optimised"
    ...
    for timestep in range(100):
        ...
        for i in range(2):
            if i ==0:
                base_dir1 = Path.cwd() / "DIC results/In pipe/Static/In plane/optimised"
                base_dir2 = Path.cwd() / "DIC results/Out of pipe/Static/In plane/optimised"
            else:
                base_dir1 = Path.cwd() / "DIC results/In pipe/Static/Out of plane/optimised"
                base_dir2 = Path.cwd() / "DIC results/Out of pipe/Static/Out of plane/optimised"
    ...
    fig.suptitle("Static images", size=16)
    fig.text(0.475, 0.9, "Inside pipe", size=14)
    fig.text(0.475, 0.48, "Outside pipe", size=14)

    # plt.show()
    filename = Path.cwd() / "DIC results/In pipe/Static/noisefloor"
