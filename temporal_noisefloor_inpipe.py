...
def main() -> None:
    ...
    base_dir2 = Path.cwd() / "DIC results/In pipe/Out of plane/new_calib"
    ...
    fig.suptitle("Systematic and random error from rigid body motion images", size=16)
    fig.text(0.425, 0.9, "In plane rigid body motion", size=14)
    fig.text(0.425, 0.48, "Out of plane rigid body motion", size=14)

    # plt.show()
    filename = Path.cwd() / "Error_maps/noisefloor_rbm.svg"
